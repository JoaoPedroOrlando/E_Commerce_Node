...
export class CreateProducts1643139062170 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.createTable(
            ...
            new TableForeignKey({columnNames: ["categoria_id"], // coluna (mesmo nome definido anteriormente)
